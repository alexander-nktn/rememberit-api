...
-- changeset alexander:1735791671861-1
...
-- changeset alexander:1735791671861-4
...
-- changeset alexander:1735791671861-5
CREATE TABLE roles (id VARCHAR(255) NOT NULL, name VARCHAR(255), CONSTRAINT "rolesPK" PRIMARY KEY (id));

-- changeset alexander:1735791671861-6
CREATE TABLE translations (id VARCHAR(255) NOT NULL, source_language VARCHAR(255) NOT NULL, target_language VARCHAR(255) NOT NULL, text VARCHAR(255) NOT NULL, "translatedText" VARCHAR(255) NOT NULL, CONSTRAINT "translationsPK" PRIMARY KEY (id));

-- changeset alexander:1735791671861-7
